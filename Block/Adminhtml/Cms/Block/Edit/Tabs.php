 ...
 * @author    Bharat
 */
namespace SixtySeven\CMSScheduler\Block\Adminhtml\Cms\Block\Edit;
...
class Tabs extends \Magento\Backend\Block\Widget
{
     ...
     * @var string
     */
    protected $_destElementId = 'collapsable_contents';
     ...
     * @param \Magento\Framework\Json\EncoderInterface
